      ...
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        <div className="h-1/2 flex flex-col gap-8 items-center justify-center lg:h-full lg:w-1/2">
          ...
          <p className="md:text-xl">
            Hire me for expert freelance software development services tailored
            to your needs. With a focus on quality, efficiency, and innovation,
            I deliver custom solutions across web, mobile, and desktop
            platforms. Let's turn your ideas into reality and propel your
